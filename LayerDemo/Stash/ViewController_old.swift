...
//    }
//    
//    func exportAnimatedVideo() {
//        let layerRenderer = try! OffScreenRenderer(device: MTL_DEVICE)
//        let layer = canvasView.layer//LayerBuilder.shared.buildLayer(with: templateModel)
//        do{
//            try layerRenderer.setLayer(layer)
//        }catch{
//            print("🛑 can't set the layer to offscrren renderer .. !")
//            //completion(false,TextTemplateModel())
//        }
//        
//        try! layerRenderer.setLayer(layer)
//        var images = layerRenderer.renderCIImages(
//            frameDuration: CMTime(value: 1, timescale: 25),
//            timeRange: CMTimeRange(start: CMTime(value: 1, timescale: 25), end: CMTime(seconds: 1.2, preferredTimescale: 600))
//        )
//        
//    }
//    
